...
import { addValuationCommentAction } from "@/lib/valuation/actions";
import type { ValuationComment } from "@/lib/api/types";
...
export function InternalComments({
  ...
  function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      await addValuationCommentAction(requestId, body);
